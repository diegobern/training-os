...
**Authentication → Templates**: ahí se edita el email de recuperar contraseña —
el único que Training OS envía. Cambia al menos el nombre del remitente para que no llegue como
